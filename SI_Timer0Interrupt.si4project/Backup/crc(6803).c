...
unsigned short modbus_crc16_calc(unsigned char data, unsigned short crc)
{
    unsigned char  i = 0;
...
unsigned char modbus_crc16_check(unsigned char *buf, unsigned short buf_len)
{
    ...
    {
        DEBUG_ERROR("MODBUS:crc[%x] is invalid crc1[%x] crc2[%x]\r\n", crc, buf[buf_len-2], buf[buf_len-1]);
        return ERROR;
    }
